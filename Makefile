...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account sepoliaAccount --sender 0x10662720A8Dc45d3c8a0CA3240767b798999077b --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY)
